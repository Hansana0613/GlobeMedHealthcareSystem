 ...
 * @author Hansana
 */
public class TreatmentReportBuilder implements ReportBuilder {

    private Report report;
    private TreatmentReportVisitor visitor;
    private List<String> customSections;

    public TreatmentReportBuilder() {
        this.visitor = new TreatmentReportVisitor();
    ...
    public Report build() {
        ...
        report.setType("TREATMENT_SUMMARY");
